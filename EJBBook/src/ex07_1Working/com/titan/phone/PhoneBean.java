...
public abstract class PhoneBean implements javax.ejb.EntityBean {
    ...
    public Object ejbCreate(Integer id, String number, byte type) throws CreateException
    {
    ...
    public void ejbPostCreate(Integer id, String number, byte type) throws CreateException {
