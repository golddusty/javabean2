...
public abstract class CabinBean implements javax.ejb.EntityBean {
    ...
    public Integer ejbCreate(Integer id, ShipLocal ship, String name, int count, int level) throws CreateException {
		this.setId(id);
		this.setName(name);
	...
	public void ejbPostCreate(Integer id, ShipLocal ship, String name, int count, int level)throws CreateException {
		this.setShip(ship);
	}
